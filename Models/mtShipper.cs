...
namespace fms.Models
{
    public class mtShipper
    {
        ...
        [MaxLength(50, ErrorMessage = "QQ maksimal 50 karakter")]
        [Required(ErrorMessage = "QQ harus di isi")]
        [Display(Name = "QQ")]
        ...
        public ICollection<mtAgentProfitShared> profitShareds { get; set; }
        public ICollection<mtShipperDetails> mtShipperDetails { get; set; }
    }
}
